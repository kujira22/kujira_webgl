...
function pageIntro(container) {
    ...
    // Conditional animations for work-detail and news-detail
    if (container.querySelector('#work-detail')) {
        gsap.to(container.querySelectorAll('.back-button-holder-work'), {
            opacity: 1,
            duration: 0.3,
            ease: "power4.out",
        });
    ...
    if (container.querySelector('#news-detail')) {
        gsap.to(container.querySelectorAll('.back-button-holder-news'), {
            opacity: 1,
            duration: 0.3,
            ease: "power4.out",
        });
