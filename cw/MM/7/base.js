...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function N0(i,e,t){const n=new Float32Array(Ai),r=new F(0,1,0);return new Sn({name:"SphericalGaussianBlur",defines:{n:Ai,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function uh(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function hh(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qs(),fragmentShader:`
	...
	`}class dh extends vn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zu(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Hr(5,5,5),s=new Sn({name:"CubemapFromEquirect",uniforms:ir(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ut,blending:Pn});s.uniforms.tEquirect.value=t;const o=new zt(r,s),a=t.minFilter;return t.minFilter===In&&(t.minFilter=yt),new og(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,n,r);e.setRenderTarget(s)}}function U0(i){let e=new WeakMap,t=new WeakMap,n=null;function r(h,f=!1){return h==null?null:f?o(h):s(h)}function s(h){if(h&&h.isTexture){const f=h.mapping;if(f===No||f===Uo)if(e.has(h)){const g=e.get(h).texture;return a(g,h.mapping)}else{const g=h.image;if(g&&g.height>0){const _=new dh(g.height);return _.fromEquirectangularTexture(i,h),e.set(h,_),h.addEventListener("dispose",c),a(_.texture,h.mapping)}else return null}}return h}function o(h){if(h&&h.isTexture){const f=h.mapping,g=f===No||f===Uo,_=f===_i||f===Bi;if(g||_){let m=t.get(h);const p=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==p)return n===null&&(n=new lh(i)),m=g?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const S=h.image;return g&&S&&S.height>0||_&&S&&l(S)?(n===null&&(n=new lh(i)),m=g?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function a(h,f){return f===No?h.mapping=_i:f===Uo&&(h.mapping=Bi),h}function l(h){let f=0;const g=6;for(let _=0;_<g;_++)h[_]!==void 0&&f++;return f===g}function c(h){const f=h.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:d}}function F0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Aa("WebGLRenderer: "+n+" extension not supported."),r}}}function O0(i,e,t,n){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);h.removeEventListener("dispose",o),delete r[h.id];const f=s.get(h);f&&(e.remove(f),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,g=d.attributes.position;let _=0;if(g===void 0)return;if(f!==null){const S=f.array;_=f.version;for(let M=0,E=S.length;M<E;M+=3){const R=S[M+0],T=S[M+1],C=S[M+2];h.push(R,T,T,C,C,R)}}else{const S=g.array;_=g.version;for(let M=0,E=S.length/3-1;M<E;M+=3){const R=M+0,T=M+1,C=M+2;h.push(R,T,T,C,C,R)}}const m=new(g.count>=65535?Su:yu)(h,1);m.version=_;const p=s.get(d);p&&e.remove(p),s.set(d,m)}function u(d){const h=s.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:u}}function B0(i,e,t){let n;function r(d){n=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,h){i.drawElements(n,h,s,d*o),t.update(h,n,1)}function c(d,h,f){f!==0&&(i.drawElementsInstanced(n,h,s,d*o,f),t.update(h,n,f))}function u(d,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,s,d,0,f);let _=0;for(let m=0;m<f;m++)_+=h[m];t.update(_,n,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function k0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:Re("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function V0(i,e,t){const n=new WeakMap,r=new rt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(a);if(h===void 0||h.count!==d){let A=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",A)};h!==void 0&&h.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let M=0;f===!0&&(M=1),g===!0&&(M=2),_===!0&&(M=3);let E=a.attributes.position.count*M,R=1;E>e.maxTextureSize&&(R=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const T=new Float32Array(E*R*4*d),C=new cu(T,E,R,d);C.type=Xt,C.needsUpdate=!0;const x=M*4;for(let P=0;P<d;P++){const w=m[P],L=p[P],G=S[P],B=E*R*4*P;for(let N=0;N<w.count;N++){const V=N*x;f===!0&&(r.fromBufferAttribute(w,N),T[B+V+0]=r.x,T[B+V+1]=r.y,T[B+V+2]=r.z,T[B+V+3]=0),g===!0&&(r.fromBufferAttribute(L,N),T[B+V+4]=r.x,T[B+V+5]=r.y,T[B+V+6]=r.z,T[B+V+7]=0),_===!0&&(r.fromBufferAttribute(G,N),T[B+V+8]=r.x,T[B+V+9]=r.y,T[B+V+10]=r.z,T[B+V+11]=G.itemSize===4?r.w:1)}}h={count:d,texture:C,size:new Ye(E,R)},n.set(a,h),a.addEventListener("dispose",A)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function z0(i,e,t,n,r){let s=new WeakMap;function o(c){const u=r.render.frame,d=c.geometry,h=e.get(c,d);if(s.get(h)!==u&&(e.update(h),s.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==u&&(f.update(),s.set(f,u))}return h}function a(){s=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:o,dispose:a}}const H0={[Fc]:"LINEAR_TONE_MAPPING",[Oc]:"REINHARD_TONE_MAPPING",[Bc]:"CINEON_TONE_MAPPING",[kc]:"ACES_FILMIC_TONE_MAPPING",[zc]:"AGX_TONE_MAPPING",[Hc]:"NEUTRAL_TONE_MAPPING",[Vc]:"CUSTOM_TONE_MAPPING"};function G0(i,e,t,n,r){const s=new vn(e,t,{type:i,depthBuffer:n,stencilBuffer:r,depthTexture:n?new nr(e,t):void 0}),o=new vn(e,t,{type:Ln,depthBuffer:!1,stencilBuffer:!1}),a=new Kt;a.setAttribute("position",new ln([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new ln([0,2,0,0,2,0],2));const l=new Bm({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new zt(a,l),u=new Ws(-1,1,1,-1,0,1);let d=null,h=null,f=!1,g,_=null,m=[],p=!1;this.setSize=function(S,M){s.setSize(S,M),o.setSize(S,M);for(let E=0;E<m.length;E++){const R=m[E];R.setSize&&R.setSize(S,M)}},this.setEffects=function(S){m=S,p=m.length>0&&m[0].isRenderPass===!0;const M=s.width,E=s.height;for(let R=0;R<m.length;R++){const T=m[R];T.setSize&&T.setSize(M,E)}},this.begin=function(S,M){if(f||S.toneMapping===pn&&m.length===0)return!1;if(_=M,M!==null){const E=M.width,R=M.height;(s.width!==E||s.height!==R)&&this.setSize(E,R)}return p===!1&&S.setRenderTarget(s),g=S.toneMapping,S.toneMapping=pn,!0},this.hasRenderPass=function(){return p},this.end=function(S,M){S.toneMapping=g,f=!0;let E=s,R=o;for(let T=0;T<m.length;T++){const C=m[T];if(C.enabled!==!1&&(C.render(S,R,E,M),C.needsSwap!==!1)){const x=E;E=R,R=x}}if(d!==S.outputColorSpace||h!==S.toneMapping){d=S.outputColorSpace,h=S.toneMapping,l.defines={},Ge.getTransfer(d)===Je&&(l.defines.SRGB_TRANSFER="");const T=H0[h];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,S.setRenderTarget(_),S.render(c,u),_=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const fh=new Et,xl=new nr(1,1),ph=new cu,mh=new am,gh=new zu,_h=[],vh=[],xh=new Float32Array(16),yh=new Float32Array(9),Sh=new Float32Array(4);function mr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=_h[r];if(s===void 0&&(s=new Float32Array(r),_h[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Mt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ys(i,e){let t=vh[e];t===void 0&&(t=new Int32Array(e),vh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function W0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function X0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),Mt(t,e)}}function q0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),Mt(t,e)}}function Y0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),Mt(t,e)}}function j0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,n))return;Sh.set(n),i.uniformMatrix2fv(this.addr,!1,Sh),Mt(t,n)}}function K0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,n))return;yh.set(n),i.uniformMatrix3fv(this.addr,!1,yh),Mt(t,n)}}function $0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Mt(t,e)}else{if(St(t,n))return;xh.set(n),i.uniformMatrix4fv(this.addr,!1,xh),Mt(t,n)}}function Z0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function J0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),Mt(t,e)}}function Q0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),Mt(t,e)}}function ev(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),Mt(t,e)}}function tv(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function nv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),Mt(t,e)}}function iv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),Mt(t,e)}}function rv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),Mt(t,e)}}function sv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(xl.compareFunction=t.isReversedDepthBuffer()?Ea:ba,s=xl):s=fh,t.setTexture2D(e||s,r)}function ov(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||mh,r)}function av(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||gh,r)}function lv(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||ph,r)}function cv(i){switch(i){case 5126:return W0;case 35664:return X0;case 35665:return q0;case 35666:return Y0;case 35674:return j0;case 35675:return K0;case 35676:return $0;case 5124:case 35670:return Z0;case 35667:case 35671:return J0;case 35668:case 35672:return Q0;case 35669:case 35673:return ev;case 5125:return tv;case 36294:return nv;case 36295:return iv;case 36296:return rv;case 35678:case 36198:case 36298:case 36306:case 35682:return sv;case 35679:case 36299:case 36307:return ov;case 35680:case 36300:case 36308:case 36293:return av;case 36289:case 36303:case 36311:case 36292:return lv}}function uv(i,e){i.uniform1fv(this.addr,e)}function hv(i,e){const t=mr(e,this.size,2);i.uniform2fv(this.addr,t)}function dv(i,e){const t=mr(e,this.size,3);i.uniform3fv(this.addr,t)}function fv(i,e){const t=mr(e,this.size,4);i.uniform4fv(this.addr,t)}function pv(i,e){const t=mr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function mv(i,e){const t=mr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function gv(i,e){const t=mr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function _v(i,e){i.uniform1iv(this.addr,e)}function vv(i,e){i.uniform2iv(this.addr,e)}function xv(i,e){i.uniform3iv(this.addr,e)}function yv(i,e){i.uniform4iv(this.addr,e)}function Sv(i,e){i.uniform1uiv(this.addr,e)}function Mv(i,e){i.uniform2uiv(this.addr,e)}function bv(i,e){i.uniform3uiv(this.addr,e)}function Ev(i,e){i.uniform4uiv(this.addr,e)}function Tv(i,e,t){const n=this.cache,r=e.length,s=Ys(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));let o;this.type===i.SAMPLER_2D_SHADOW?o=xl:o=fh;for(let a=0;a!==r;++a)t.setTexture2D(e[a]||o,s[a])}function Av(i,e,t){const n=this.cache,r=e.length,s=Ys(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||mh,s[o])}function wv(i,e,t){const n=this.cache,r=e.length,s=Ys(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||gh,s[o])}function Rv(i,e,t){const n=this.cache,r=e.length,s=Ys(t,r);St(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||ph,s[o])}function Cv(i){switch(i){case 5126:return uv;case 35664:return hv;case 35665:return dv;case 35666:return fv;case 35674:return pv;case 35675:return mv;case 35676:return gv;case 5124:case 35670:return _v;case 35667:case 35671:return vv;case 35668:case 35672:return xv;case 35669:case 35673:return yv;case 5125:return Sv;case 36294:return Mv;case 36295:return bv;case 36296:return Ev;case 35678:case 36198:case 36298:case 36306:case 35682:return Tv;case 35679:case 36299:case 36307:return Av;case 35680:case 36300:case 36308:case 36293:return wv;case 36289:case 36303:case 36311:case 36292:return Rv}}class Pv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=cv(t.type)}}class Iv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Cv(t.type)}}class Lv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const yl=/(\w+)(\])?(\[|\.)?/g;function Mh(i,e){i.seq.push(e),i.map[e.id]=e}function Dv(i,e,t){const n=i.name,r=n.length;for(yl.lastIndex=0;;){const s=yl.exec(n),o=yl.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Mh(t,c===void 0?new Pv(a,i,e):new Iv(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new Lv(a),Mh(t,d)),t=d}}}class js{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=e.getActiveUniform(t,o),l=e.getUniformLocation(t,a.name);Dv(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function bh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Nv=37297;let Uv=0;function Fv(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Eh=new Ie;function Ov(i){Ge._getMatrix(Eh,Ge.workingColorSpace,i);const e=`mat3( ${Eh.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(i)){case ds:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return ye("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Th(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+Fv(i.getShaderSource(e),a)}else return s}function Bv(i,e){const t=Ov(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const kv={[Fc]:"Linear",[Oc]:"Reinhard",[Bc]:"Cineon",[kc]:"ACESFilmic",[zc]:"AgX",[Hc]:"Neutral",[Vc]:"Custom"};function Vv(i,e){const t=kv[e];return t===void 0?(ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ks=new F;function zv(){Ge.getLuminanceCoefficients(Ks);const i=Ks.x.toFixed(4),e=Ks.y.toFixed(4),t=Ks.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Hv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Xr).join(`
`)}function Gv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Wv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Xr(i){return i!==""}function Ah(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Xv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Sl(i){return i.replace(Xv,Yv)}const qv=new Map;function Yv(i,e){let t=Oe[e];if(t===void 0){const n=qv.get(e);if(n!==void 0)t=Oe[n],ye('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Sl(t)}const jv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Rh(i){return i.replace(jv,Kv)}function Kv(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ch(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const $v={[ts]:"SHADOWMAP_TYPE_PCF",[Er]:"SHADOWMAP_TYPE_VSM"};function Zv(i){return $v[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Jv={[_i]:"ENVMAP_TYPE_CUBE",[Bi]:"ENVMAP_TYPE_CUBE",[ns]:"ENVMAP_TYPE_CUBE_UV"};function Qv(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Jv[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ex={[Bi]:"ENVMAP_MODE_REFRACTION"};function tx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ex[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const nx={[Uc]:"ENVMAP_BLENDING_MULTIPLY",[yp]:"ENVMAP_BLENDING_MIX",[Sp]:"ENVMAP_BLENDING_ADD"};function ix(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":nx[i.combine]||"ENVMAP_BLENDING_NONE"}function rx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function sx(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Zv(t),c=Qv(t),u=tx(t),d=ix(t),h=rx(t),f=Hv(t),g=Gv(s),_=r.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,document.head.append(i)}const Wh=1.2,Xh="power1.out",Ey=.8,Ty="power4.inOut",Zs=11,qh=3,Yh=.12,Rl=.12,Ay=1,wy=1,jr=.2,Cl=1,jh=.4,Kh=.2;function Ry(i=document){const e=window.gsap,t=i.querySelector('[data-shots="hero"]'),n=t==null?void 0:t.querySelector('[data-bgvid="true"]'),r=n==null?void 0:n.querySelector("video"),s=i.querySelector(".method"),o=i.querySelector(".madness"),a=i.querySelector(".and");return!e||!t||!r?(i.dataset.homeIntroReady="true",Promise.resolve()):Ly(r).then(()=>{const l=Cy(),c=Py(a),u={scale:0,rotation:qh};return e.set(i,{opacity:1,position:"fixed",inset:0,width:"100%",zIndex:1}),Ui(i,u.scale,u.rotation),e.set(n,{scale:Rl,transformOrigin:"50% 50%"}),e.set(s,{x:`-${Zs}vw`}),e.set(o,{x:`${Zs}vw`}),i.dataset.homeIntroReady="true",e.timeline().to(u,{scale:Yh,duration:Wh,ease:Xh,onUpdate:()=>Ui(i,u.scale,u.rotation)}).to(n,{scale:Rl,duration:Wh,ease:Xh},0).add("pop").set(c==null?void 0:c.outer,{opacity:0,autoAlpha:0,visibility:"visible"},`pop+=${jr}`).to(c==null?void 0:c.outer,{opacity:1,autoAlpha:1,duration:jh,ease:"power2.out"},`pop+=${jr}`).add(()=>Jl(t,{force:!0}),`pop+=${jr+Cl+Kh}`).add(()=>Ql(i),`pop+=${jr+Cl+Kh}`).to(c==null?void 0:c.outer,{opacity:0,duration:jh,ease:"power3.inOut",onComplete:()=>{Iy(c)}},`pop+=${jr+Cl}`).to({progress:0},{progress:1,duration:Ey,ease:Ty,onUpdate(){const d=this.targets()[0].progress;u.scale=Kr(Yh,Ay,d),u.rotation=Kr(qh,0,d),Ui(i,u.scale,u.rotation),e.set(n,{scale:Kr(Rl,wy,d)}),e.set(s,{x:`${Kr(-Zs,0,d)}vw`}),e.set(o,{x:`${Kr(Zs,0,d)}vw`})},onComplete(){e.set(i,{clearProps:"position,inset,width,zIndex,clipPath,webkitClipPath"}),e.set(n,{clearProps:"scale,transformOrigin"}),e.set([s,o],{clearProps:"x"}),l.remove()}},"pop")})}function Kr(i,e,t){return i+(e-i)*t}function Cy(){const i=document.createElement("div");return i.dataset.homeIntroBacking="",i.style.position="fixed",i.style.inset="0",i.style.background="#000",i.style.zIndex="0",i.style.pointerEvents="none",document.body.prepend(i),i}function Py(i){const e=window.gsap;if(!e||!i)return null;if(!i.dataset.andMaskReady){const n=document.createElement("span");n.dataset.andMaskInner="",n.textContent=i.textContent,i.textContent="",i.appendChild(n),i.dataset.andMaskReady="true"}const t=i.querySelector("[data-and-mask-inner]");return e.set(i,{opacity:0,visibility:"visible",overflow:"hidden",display:"inline-block",lineHeight:1}),e.set(t,{display:"inline-block",yPercent:0}),{outer:i,inner:t}}function Iy(i){const e=window.gsap;!e||!(i!=null&&i.outer)||!(i!=null&&i.inner)||(e.set(i.outer,{opacity:0,visibility:"visible"}),e.set(i.inner,{yPercent:0}))}function Ly(i){return i.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(e=>{const t=()=>{i.removeEventListener("loadeddata",t),i.removeEventListener("canplay",t),e()};i.addEventListener("loadeddata",t,{once:!0}),i.addEventListener("canplay",t,{once:!0})})}const Dy=18,Ny=.08,Uy=.9,Fy=4,Js=new WeakMap;function Oy(i=document){i==null||i.querySelectorAll(".client_spinner").forEach(e=>{if(Js.has(e))return;const t=ky(e);t&&Js.set(e,t)})}function By(i=document){i==null||i.querySelectorAll(".client_spinner").forEach(e=>{var t;(t=Js.get(e))==null||t.destroy(),Js.delete(e)})}function ky(i){const e=i.querySelector(".spinner_group");if(!e)return null;const t=[e];let n=0,r=0,s=0,o=window.scrollY||window.pageYOffset||0,a=performance.now(),l=null;const c={overflow:i.style.overflow,position:i.style.position,minHeight:i.style.minHeight},u=Vy(e);i.style.overflow="hidden",getComputedStyle(i).position==="static"&&(i.style.position="relative"),$h(e),d(),h(),window.addEventListener("resize",h),l=window.requestAnimationFrame(f);function d(){const g=Math.max(Fy,Math.ceil((i.clientHeight||window.innerHeight||1)/Math.max(e.offsetHeight,1))+2);for(;t.length<g;){const _=e.cloneNode(!0);_.dataset.spinnerClone="",_.setAttribute("aria-hidden","true"),$h(_),e.parentNode.insertBefore(_,Hy(i)),t.push(_)}}function h(){r=Math.max(e.offsetHeight,1),i.style.minHeight=`${r}px`,d()}function f(g){const _=Math.min((g-a)/1e3,.05),m=window.scrollY||window.pageYOffset||0,p=m-o;s=s*Uy+p*Ny,n=Gy(n+Dy*_+s,r),t.forEach((S,M)=>{S.style.transform=`translate3d(0, ${M*r-n}px, 0)`}),o=m,a=g,l=window.requestAnimationFrame(f)}return{destroy(){window.cancelAnimationFrame(l),window.removeEventListener("resize",h),t.slice(1).forEach(g=>g.remove()),zy(e,u),i.style.overflow=c.overflow,i.style.position=c.position,i.style.minHeight=c.minHeight}}}function $h(i){i.style.position="absolute",i.style.top="0",i.style.left="0",i.style.right="0",i.style.width="100%",i.style.willChange="transform"}function Vy(i){return{position:i.style.position,top:i.style.top,left:i.style.left,right:i.style.right,width:i.style.width,transform:i.style.transform,willChange:i.style.willChange}}function zy(i,e){i.style.position=e.position,i.style.top=e.top,i.style.left=e.left,i.style.right=e.right,i.style.width=e.width,i.style.transform=e.transform,i.style.willChange=e.willChange}function Hy(i){return i.querySelector(".spinner_grad")}function Gy(i,e){return(i%e+e)%e}const Wy=.4,Zh=1,Xy=.18,Qs=new WeakMap;function qy(i=document){i==null||i.querySelectorAll('[data-shots="hero"] nav').forEach(e=>{const t=[...e.querySelectorAll(".hero_link")];t.length<2||Qs.has(e)||Qs.set(e,jy(e,t))})}function Yy(i=document){i==null||i.querySelectorAll('[data-shots="hero"] nav').forEach(e=>{var t;(t=Qs.get(e))==null||t.destroy(),Qs.delete(e)})}function jy(i,e){const t=new Map(e.map(a=>[a,a.style.opacity]));let n=!1;const r=a=>{if(n)return;const l=a.currentTarget;Jh(e,l)},s=()=>{n||e.forEach(a=>Pl(a,Zh))},o=a=>{n=!0,Jh(e,a.currentTarget)};return e.forEach(a=>{a.addEventListener("mouseenter",r),a.addEventListener("focus",r),a.addEventListener("click",o)}),i.addEventListener("mouseleave",s),i.addEventListener("focusout",s),{destroy(){e.forEach(a=>{a.removeEventListener("mouseenter",r),a.removeEventListener("focus",r),a.removeEventListener("click",o),Pl(a,t.get(a)||"",!0)}),i.removeEventListener("mouseleave",s),i.removeEventListener("focusout",s)}}}function Jh(i,e){i.forEach(t=>{Pl(t,t===e?Zh:Wy)})}function Pl(i,e,t=!1){const n=window.gsap;if(n&&!t){n.to(i,{opacity:e,duration:Xy,ease:"power2.out",overwrite:!0});return}i.style.opacity=e}function Ky(){return document.readyState!=="loading"?Promise.resolve():new Promise(i=>{document.addEventListener("DOMContentLoaded",i,{once:!0})})}const Ri={three:{spin(){Wn.forEach(i=>i==null?void 0:i.spin())},animateToProgress(i,e){Wn.forEach(t=>{var n;return(n=t==null?void 0:t.animateToProgress)==null?void 0:n.call(t,i,e)})},setNamespace(i){Wn.forEach(e=>e==null?void 0:e.setNamespace(i))}},barba:null},Wn=new Map,Ft="[MM lifecycle]";Ud();const Il={home({namespace:i}){var e;(e=Ri.three)==null||e.setNamespace(i)}};async function $y(){if(await Ky(),Ri.barba=$f({onEnter:Qh,onLeave:Zy,onTransitionStart:({namespace:i}={})=>{var e,t;(e=Ri.three)==null||e.spin(),i==="home"&&((t=Ri.three)==null||t.animateToProgress(0,1.4))}}),!Ri.barba){const i=document.querySelector("[data-barba='container']");console.log(Ft,"no barba -> setup attempt",Zt(i)),Qh({container:i,namespace:Ll(i==null?void 0:i.dataset.barbaNamespace)})}}async function Qh({container:i,namespace:e,transition:t=!1}){var r,s,o;if(!i){console.log(Ft,"setup skipped -> no container");return}const n=Ll(e||i.dataset.barbaNamespace);t&&n==="home"&&(i.dataset.homeIntroReady="true"),console.log(Ft,"setup start",{...Zt(i,n),transition:t}),i.dataset.pageActive="true",document.body.dataset.page=n,nS(i)&&(console.log(Ft,"run three()",{...Zt(i,n),mounts:i.querySelectorAll("[data-three-canvas]").length}),Jy(i),(r=Ri.three)==null||r.setNamespace(n)),iS(i)&&(console.log(Ft,"run shots()",{...Zt(i,n),hero:i.querySelectorAll('[data-shots="hero"]').length,featuredLists:i.querySelectorAll("[data-featured-list]").length}),await Xd(i)),sS(i),oS(i),Oy(i),qy(i),console.log(Ft,"reinit webflow",{...Zt(i,n),hasWebflow:!!window.Webflow}),eS(),rS(i)&&(console.log(Ft,"run text()",{...Zt(i,n),transition:t}),await tS(),Kl(i),Fd(i,{autoAnimate:!t&&n!=="home"})),!t&&n==="home"&&await Ry(i),t||ic(i),(s=window.ScrollTrigger)==null||s.refresh(),console.log(Ft,"setup complete",Zt(i,n)),(o=Il[n])==null||o.call(Il,{container:i,namespace:n})}function Zy({container:i}){if(!i){console.log(Ft,"teardown skipped -> no container");return}console.log(Ft,"teardown start",Zt(i)),console.log(Ft,"stop shots",Zt(i)),qd(i),console.log(Ft,"reset text on leave",Zt(i)),Kl(i),console.log(Ft,"destroy three",{...Zt(i),mounts:i.querySelectorAll("[data-three-canvas]").length}),Qy(i),By(i),Yy(i),delete i.dataset.pageActive,console.log(Ft,"teardown complete",Zt(i))}$y();function Jy(i=document){Wn.forEach((e,t)=>{t.isConnected||(e==null||e.destroy(),Wn.delete(t))}),i==null||i.querySelectorAll("[data-three-canvas]").forEach(e=>{if(Wn.has(e))return;const t=yy({mount:e});t&&Wn.set(e,t)})}function Qy(i){i==null||i.querySelectorAll("[data-three-canvas]").forEach(e=>{var t;(t=Wn.get(e))==null||t.destroy(),Wn.delete(e)})}function Ll(i){return String(i||"page").trim().toLowerCase()}function eS(){var e,t,n,r,s;const i=window.Webflow;i&&((e=i.destroy)==null||e.call(i),(t=i.ready)==null||t.call(i),(s=(r=(n=i.require)==null?void 0:n.call(i,"ix2"))==null?void 0:r.init)==null||s.call(r))}async function tS(){var i,e,t;return await((t=(e=(i=document.fonts)==null?void 0:i.ready)==null?void 0:e.catch)==null?void 0:t.call(e,()=>{})),new Promise(n=>{requestAnimationFrame(()=>requestAnimationFrame(n))})}function Zt(i,e){var t,n;return{namespace:Ll(e||((t=i==null?void 0:i.dataset)==null?void 0:t.barbaNamespace)),active:((n=i==null?void 0:i.dataset)==null?void 0:n.pageActive)==="true",connected:!!(i!=null&&i.isConnected),className:(i==null?void 0:i.className)||""}}function nS(i){return!!(i!=null&&i.querySelector("[data-three-canvas]"))}function iS(i){return!!(i!=null&&i.querySelector("[data-shots], [data-featured-list], [data-shots-work], [data-shots-showreel], [data-showreel-id], [data-showreel-stream], [data-direct-id]"))}function rS(i){return!!(i!=null&&i.querySelector("h1, h2, h3, h4, h5, h6, p, [data-text], .filter, .w-inline-block, .body-large, .body-regular, .body-small, .link_large, .link_small, .nav_link, .heading-1, .heading-2, .heading-3, .heading-4, .heading-5, .heading-6"))}function sS(i=document){const e=i==null?void 0:i.querySelectorAll(".directors_list, .director_list, [data-directors='list']");if(!(e!=null&&e.length))return;const t=ed(window.location.pathname);e.forEach(n=>{n.querySelectorAll("a[href]").forEach(r=>{const o=ed(new URL(r.href,window.location.href).pathname)===t||r.getAttribute("aria-current")==="page"||r.classList.contains("w--current");r.style.opacity=o?"1":"",r.style.color=o?"":"#C3C3C3"})})}function ed(i){return String(i||"/").replace(/\/+$/,"")||"/"}function oS(i=document){const e=String(new Date().getFullYear());i==null||i.querySelectorAll("[data-year]").forEach(t=>{t.textContent=e})}return io.app=Ri,Object.defineProperty(io,Symbol.toStringTag,{value:"Module"}),io})({});
