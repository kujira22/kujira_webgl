...
#endif`;const Fe={alphahash_fragment:Sv,alphahash_pars_fragment:Mv,alphamap_fragment:Ev,alphamap_pars_fragment:bv,alphatest_fragment:Tv,alphatest_pars_fragment:Av,aomap_fragment:wv,aomap_pars_fragment:Rv,batching_pars_vertex:Cv,batching_vertex:Pv,begin_vertex:Iv,beginnormal_vertex:Lv,bsdfs:Dv,iridescence_fragment:Nv,bumpmap_pars_fragment:Uv,clipping_planes_fragment:Ov,clipping_planes_pars_fragment:Fv,clipping_planes_pars_vertex:Bv,clipping_planes_vertex:kv,color_fragment:Hv,color_pars_fragment:Vv,color_pars_vertex:zv,color_vertex:Gv,common:Wv,cube_uv_reflection_fragment:Xv,defaultnormal_vertex:qv,displacementmap_pars_vertex:Yv,displacementmap_vertex:Kv,emissivemap_fragment:jv,emissivemap_pars_fragment:$v,colorspace_fragment:Zv,colorspace_pars_fragment:Jv,envmap_fragment:Qv,envmap_common_pars_fragment:ex,envmap_pars_fragment:tx,envmap_pars_vertex:nx,envmap_physical_pars_fragment:fx,envmap_vertex:ix,fog_vertex:rx,fog_pars_vertex:sx,fog_fragment:ox,fog_pars_fragment:ax,gradientmap_pars_fragment:lx,lightmap_pars_fragment:cx,lights_lambert_fragment:ux,lights_lambert_pars_fragment:dx,lights_pars_begin:hx,lights_toon_fragment:px,lights_toon_pars_fragment:mx,lights_phong_fragment:gx,lights_phong_pars_fragment:_x,lights_physical_fragment:vx,lights_physical_pars_fragment:xx,lights_fragment_begin:yx,lights_fragment_maps:Sx,lights_fragment_end:Mx,lightprobes_pars_fragment:Ex,logdepthbuf_fragment:bx,logdepthbuf_pars_fragment:Tx,logdepthbuf_pars_vertex:Ax,logdepthbuf_vertex:wx,map_fragment:Rx,map_pars_fragment:Cx,map_particle_fragment:Px,map_particle_pars_fragment:Ix,metalnessmap_fragment:Lx,metalnessmap_pars_fragment:Dx,morphinstance_vertex:Nx,morphcolor_vertex:Ux,morphnormal_vertex:Ox,morphtarget_pars_vertex:Fx,morphtarget_vertex:Bx,normal_fragment_begin:kx,normal_fragment_maps:Hx,normal_pars_fragment:Vx,normal_pars_vertex:zx,normal_vertex:Gx,normalmap_pars_fragment:Wx,clearcoat_normal_fragment_begin:Xx,clearcoat_normal_fragment_maps:qx,clearcoat_pars_fragment:Yx,iridescence_pars_fragment:Kx,opaque_fragment:jx,packing:$x,premultiplied_alpha_fragment:Zx,project_vertex:Jx,dithering_fragment:Qx,dithering_pars_fragment:ey,roughnessmap_fragment:ty,roughnessmap_pars_fragment:ny,shadowmap_pars_fragment:iy,shadowmap_pars_vertex:ry,shadowmap_vertex:sy,shadowmask_pars_fragment:oy,skinbase_vertex:ay,skinning_pars_vertex:ly,skinning_vertex:cy,skinnormal_vertex:uy,specularmap_fragment:dy,specularmap_pars_fragment:hy,tonemapping_fragment:fy,tonemapping_pars_fragment:py,transmission_fragment:my,transmission_pars_fragment:gy,uv_pars_fragment:_y,uv_pars_vertex:vy,uv_vertex:xy,worldpos_vertex:yy,background_vert:`varying vec2 vUv;
uniform mat3 uvTransform;
void main() {
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function Ah(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:Pn,depthTest:!1,depthWrite:!1})}function wh(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
	...
	`}class Rh extends _n{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ih(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Wr(5,5,5),s=new yn({name:"CubemapFromEquirect",uniforms:ir(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ut,blending:Pn});s.uniforms.tEquirect.value=t;const o=new Vt(r,s),a=t.minFilter;return t.minFilter===In&&(t.minFilter=St),new iv(1,10,this).update(e,o),t.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(t,n,r);e.setRenderTarget(s)}}function Ly(i){let e=new WeakMap,t=new WeakMap,n=null;function r(d,f=!1){return d==null?null:f?o(d):s(d)}function s(d){if(d&&d.isTexture){const f=d.mapping;if(f===ia||f===ra)if(e.has(d)){const g=e.get(d).texture;return a(g,d.mapping)}else{const g=d.image;if(g&&g.height>0){const _=new Rh(g.height);return _.fromEquirectangularTexture(i,d),e.set(d,_),d.addEventListener("dispose",c),a(_.texture,d.mapping)}else return null}}return d}function o(d){if(d&&d.isTexture){const f=d.mapping,g=f===ia||f===ra,_=f===gi||f===Bi;if(g||_){let m=t.get(d);const p=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==p)return n===null&&(n=new bh(i)),m=g?n.fromEquirectangular(d,m):n.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),m.texture;if(m!==void 0)return m.texture;{const S=d.image;return g&&S&&S.height>0||_&&S&&l(S)?(n===null&&(n=new bh(i)),m=g?n.fromEquirectangular(d):n.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),d.addEventListener("dispose",u),m.texture):null}}}return d}function a(d,f){return f===ia?d.mapping=gi:f===ra&&(d.mapping=Bi),d}function l(d){let f=0;const g=6;for(let _=0;_<g;_++)d[_]!==void 0&&f++;return f===g}function c(d){const f=d.target;f.removeEventListener("dispose",c);const g=e.get(f);g!==void 0&&(e.delete(f),g.dispose())}function u(d){const f=d.target;f.removeEventListener("dispose",u);const g=t.get(f);g!==void 0&&(t.delete(f),g.dispose())}function h(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:h}}function Dy(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&ja("WebGLRenderer: "+n+" extension not supported."),r}}}function Ny(i,e,t,n){const r={},s=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",o),delete r[d.id];const f=s.get(d);f&&(e.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return r[d.id]===!0||(d.addEventListener("dispose",o),r[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const f in d)e.update(d[f],i.ARRAY_BUFFER)}function c(h){const d=[],f=h.index,g=h.attributes.position;let _=0;if(g===void 0)return;if(f!==null){const S=f.array;_=f.version;for(let M=0,E=S.length;M<E;M+=3){const R=S[M+0],T=S[M+1],C=S[M+2];d.push(R,T,T,C,C,R)}}else{const S=g.array;_=g.version;for(let M=0,E=S.length/3-1;M<E;M+=3){const R=M+0,T=M+1,C=M+2;d.push(R,T,T,C,C,R)}}const m=new(g.count>=65535?Fd:Od)(d,1);m.version=_;const p=s.get(h);p&&e.remove(p),s.set(h,m)}function u(h){const d=s.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return s.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function Uy(i,e,t){let n;function r(h){n=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function l(h,d){i.drawElements(n,d,s,h*o),t.update(d,n,1)}function c(h,d,f){f!==0&&(i.drawElementsInstanced(n,d,s,h*o,f),t.update(d,n,f))}function u(h,d,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,d,0,s,h,0,f);let _=0;for(let m=0;m<f;m++)_+=d[m];t.update(_,n,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function Oy(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:Re("WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Fy(i,e,t){const n=new WeakMap,r=new rt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let A=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",A)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let M=0;f===!0&&(M=1),g===!0&&(M=2),_===!0&&(M=3);let E=a.attributes.position.count*M,R=1;E>e.maxTextureSize&&(R=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const T=new Float32Array(E*R*4*h),C=new Td(T,E,R,h);C.type=Xt,C.needsUpdate=!0;const x=M*4;for(let P=0;P<h;P++){const w=m[P],L=p[P],G=S[P],B=E*R*4*P;for(let N=0;N<w.count;N++){const H=N*x;f===!0&&(r.fromBufferAttribute(w,N),T[B+H+0]=r.x,T[B+H+1]=r.y,T[B+H+2]=r.z,T[B+H+3]=0),g===!0&&(r.fromBufferAttribute(L,N),T[B+H+4]=r.x,T[B+H+5]=r.y,T[B+H+6]=r.z,T[B+H+7]=0),_===!0&&(r.fromBufferAttribute(G,N),T[B+H+8]=r.x,T[B+H+9]=r.y,T[B+H+10]=r.z,T[B+H+11]=G.itemSize===4?r.w:1)}}d={count:h,texture:C,size:new Ye(E,R)},n.set(a,d),a.addEventListener("dispose",A)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:s}}function By(i,e,t,n,r){let s=new WeakMap;function o(c){const u=r.render.frame,h=c.geometry,d=e.get(c,h);if(s.get(d)!==u&&(e.update(d),s.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;s.get(f)!==u&&(f.update(),s.set(f,u))}return d}function a(){s=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:o,dispose:a}}const ky={[Ju]:"LINEAR_TONE_MAPPING",[Qu]:"REINHARD_TONE_MAPPING",[ed]:"CINEON_TONE_MAPPING",[td]:"ACES_FILMIC_TONE_MAPPING",[id]:"AGX_TONE_MAPPING",[rd]:"NEUTRAL_TONE_MAPPING",[nd]:"CUSTOM_TONE_MAPPING"};function Hy(i,e,t,n,r){const s=new _n(e,t,{type:i,depthBuffer:n,stencilBuffer:r,depthTexture:n?new nr(e,t):void 0}),o=new _n(e,t,{type:Ln,depthBuffer:!1,stencilBuffer:!1}),a=new jt;a.setAttribute("position",new ln([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new ln([0,2,0,0,2,0],2));const l=new U0({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Vt(a,l),u=new to(-1,1,1,-1,0,1);let h=null,d=null,f=!1,g,_=null,m=[],p=!1;this.setSize=function(S,M){s.setSize(S,M),o.setSize(S,M);for(let E=0;E<m.length;E++){const R=m[E];R.setSize&&R.setSize(S,M)}},this.setEffects=function(S){m=S,p=m.length>0&&m[0].isRenderPass===!0;const M=s.width,E=s.height;for(let R=0;R<m.length;R++){const T=m[R];T.setSize&&T.setSize(M,E)}},this.begin=function(S,M){if(f||S.toneMapping===fn&&m.length===0)return!1;if(_=M,M!==null){const E=M.width,R=M.height;(s.width!==E||s.height!==R)&&this.setSize(E,R)}return p===!1&&S.setRenderTarget(s),g=S.toneMapping,S.toneMapping=fn,!0},this.hasRenderPass=function(){return p},this.end=function(S,M){S.toneMapping=g,f=!0;let E=s,R=o;for(let T=0;T<m.length;T++){const C=m[T];if(C.enabled!==!1&&(C.render(S,R,E,M),C.needsSwap!==!1)){const x=E;E=R,R=x}}if(h!==S.outputColorSpace||d!==S.toneMapping){h=S.outputColorSpace,d=S.toneMapping,l.defines={},Ge.getTransfer(h)===Je&&(l.defines.SRGB_TRANSFER="");const T=ky[d];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=E.texture,S.setRenderTarget(_),S.render(c,u),_=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),o.dispose(),a.dispose(),l.dispose()}}const Ch=new Tt,zl=new nr(1,1),Ph=new Td,Ih=new r0,Lh=new ih,Dh=[],Nh=[],Uh=new Float32Array(16),Oh=new Float32Array(9),Fh=new Float32Array(4);function mr(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Dh[r];if(s===void 0&&(s=new Float32Array(r),Dh[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function Mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Et(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ro(i,e){let t=Nh[e];t===void 0&&(t=new Int32Array(e),Nh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Vy(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function zy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2fv(this.addr,e),Et(t,e)}}function Gy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Mt(t,e))return;i.uniform3fv(this.addr,e),Et(t,e)}}function Wy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4fv(this.addr,e),Et(t,e)}}function Xy(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(Mt(t,n))return;Fh.set(n),i.uniformMatrix2fv(this.addr,!1,Fh),Et(t,n)}}function qy(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(Mt(t,n))return;Oh.set(n),i.uniformMatrix3fv(this.addr,!1,Oh),Et(t,n)}}function Yy(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(Mt(t,n))return;Uh.set(n),i.uniformMatrix4fv(this.addr,!1,Uh),Et(t,n)}}function Ky(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function jy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2iv(this.addr,e),Et(t,e)}}function $y(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3iv(this.addr,e),Et(t,e)}}function Zy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4iv(this.addr,e),Et(t,e)}}function Jy(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Qy(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2uiv(this.addr,e),Et(t,e)}}function eS(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3uiv(this.addr,e),Et(t,e)}}function tS(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4uiv(this.addr,e),Et(t,e)}}function nS(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(zl.compareFunction=t.isReversedDepthBuffer()?Ya:qa,s=zl):s=Ch,t.setTexture2D(e||s,r)}function iS(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Ih,r)}function rS(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Lh,r)}function sS(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Ph,r)}function oS(i){switch(i){case 5126:return Vy;case 35664:return zy;case 35665:return Gy;case 35666:return Wy;case 35674:return Xy;case 35675:return qy;case 35676:return Yy;case 5124:case 35670:return Ky;case 35667:case 35671:return jy;case 35668:case 35672:return $y;case 35669:case 35673:return Zy;case 5125:return Jy;case 36294:return Qy;case 36295:return eS;case 36296:return tS;case 35678:case 36198:case 36298:case 36306:case 35682:return nS;case 35679:case 36299:case 36307:return iS;case 35680:case 36300:case 36308:case 36293:return rS;case 36289:case 36303:case 36311:case 36292:return sS}}function aS(i,e){i.uniform1fv(this.addr,e)}function lS(i,e){const t=mr(e,this.size,2);i.uniform2fv(this.addr,t)}function cS(i,e){const t=mr(e,this.size,3);i.uniform3fv(this.addr,t)}function uS(i,e){const t=mr(e,this.size,4);i.uniform4fv(this.addr,t)}function dS(i,e){const t=mr(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function hS(i,e){const t=mr(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function fS(i,e){const t=mr(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function pS(i,e){i.uniform1iv(this.addr,e)}function mS(i,e){i.uniform2iv(this.addr,e)}function gS(i,e){i.uniform3iv(this.addr,e)}function _S(i,e){i.uniform4iv(this.addr,e)}function vS(i,e){i.uniform1uiv(this.addr,e)}function xS(i,e){i.uniform2uiv(this.addr,e)}function yS(i,e){i.uniform3uiv(this.addr,e)}function SS(i,e){i.uniform4uiv(this.addr,e)}function MS(i,e,t){const n=this.cache,r=e.length,s=ro(t,r);Mt(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));let o;this.type===i.SAMPLER_2D_SHADOW?o=zl:o=Ch;for(let a=0;a!==r;++a)t.setTexture2D(e[a]||o,s[a])}function ES(i,e,t){const n=this.cache,r=e.length,s=ro(t,r);Mt(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Ih,s[o])}function bS(i,e,t){const n=this.cache,r=e.length,s=ro(t,r);Mt(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Lh,s[o])}function TS(i,e,t){const n=this.cache,r=e.length,s=ro(t,r);Mt(n,s)||(i.uniform1iv(this.addr,s),Et(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Ph,s[o])}function AS(i){switch(i){case 5126:return aS;case 35664:return lS;case 35665:return cS;case 35666:return uS;case 35674:return dS;case 35675:return hS;case 35676:return fS;case 5124:case 35670:return pS;case 35667:case 35671:return mS;case 35668:case 35672:return gS;case 35669:case 35673:return _S;case 5125:return vS;case 36294:return xS;case 36295:return yS;case 36296:return SS;case 35678:case 36198:case 36298:case 36306:case 35682:return MS;case 35679:case 36299:case 36307:return ES;case 35680:case 36300:case 36308:case 36293:return bS;case 36289:case 36303:case 36311:case 36292:return TS}}class wS{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=oS(t.type)}}class RS{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=AS(t.type)}}class CS{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Gl=/(\w+)(\])?(\[|\.)?/g;function Bh(i,e){i.seq.push(e),i.map[e.id]=e}function PS(i,e,t){const n=i.name,r=n.length;for(Gl.lastIndex=0;;){const s=Gl.exec(n),o=Gl.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Bh(t,c===void 0?new wS(a,i,e):new RS(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new CS(a),Bh(t,h)),t=h}}}class so{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let o=0;o<n;++o){const a=e.getActiveUniform(t,o),l=e.getUniformLocation(t,a.name);PS(a,l,this)}const r=[],s=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(o):s.push(o);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function kh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const IS=37297;let LS=0;function DS(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const Hh=new Ie;function NS(i){Ge._getMatrix(Hh,Ge.workingColorSpace,i);const e=`mat3( ${Hh.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(i)){case Es:return[e,"LinearTransferOETF"];case Je:return[e,"sRGBTransferOETF"];default:return ye("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Vh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const o=/ERROR: 0:(\d+)/.exec(s);if(o){const a=parseInt(o[1]);return t.toUpperCase()+`

`+s+`

`+DS(i.getShaderSource(e),a)}else return s}function US(i,e){const t=NS(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const OS={[Ju]:"Linear",[Qu]:"Reinhard",[ed]:"Cineon",[td]:"ACESFilmic",[id]:"AgX",[rd]:"Neutral",[nd]:"Custom"};function FS(i,e){const t=OS[e];return t===void 0?(ye("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const oo=new O;function BS(){Ge.getLuminanceCoefficients(oo);const i=oo.x.toFixed(4),e=oo.y.toFixed(4),t=oo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function kS(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yr).join(`
`)}function HS(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function VS(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Yr(i){return i!==""}function zh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Gh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const zS=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wl(i){return i.replace(zS,WS)}const GS=new Map;function WS(i,e){let t=Fe[e];if(t===void 0){const n=GS.get(e);if(n!==void 0)t=Fe[n],ye('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Wl(t)}const XS=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Wh(i){return i.replace(XS,qS)}function qS(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Xh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const YS={[hs]:"SHADOWMAP_TYPE_PCF",[Ar]:"SHADOWMAP_TYPE_VSM"};function KS(i){return YS[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const jS={[gi]:"ENVMAP_TYPE_CUBE",[Bi]:"ENVMAP_TYPE_CUBE",[fs]:"ENVMAP_TYPE_CUBE_UV"};function $S(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":jS[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ZS={[Bi]:"ENVMAP_MODE_REFRACTION"};function JS(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ZS[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const QS={[Zu]:"ENVMAP_BLENDING_MULTIPLY",[__]:"ENVMAP_BLENDING_MIX",[v_]:"ENVMAP_BLENDING_ADD"};function eM(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":QS[i.combine]||"ENVMAP_BLENDING_NONE"}function tM(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function nM(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=KS(t),c=$S(t),u=JS(t),h=eM(t),d=tM(t),f=kS(t),g=HS(s),_=r.createProgram();let m,p,S=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,document.head.append(i)}const af=1.2,lf="power1.out",cf=.8,SE=cf+.05,ME="power4.inOut",EE="power4.inOut",uf=11,df=3,hf=.12,Zl=.12,bE=1,TE=1,Jl=.2,ff=1,pf=.4,mf=.2,AE="(min-width: 992px)";function wE(i=document){const e=window.gsap,t=i.querySelector('[data-shots="hero"]'),n=t==null?void 0:t.querySelector('[data-bgvid="true"]'),r=n==null?void 0:n.querySelector("video"),s=PE(),o=s;let a=s?i.querySelector(".method"):null,l=s?i.querySelector(".madness"):null;const c=o?i.querySelector(".and"):null;return!e||!t||!r?(i.dataset.homeIntroReady="true",Promise.resolve()):Promise.all([NE(r),s?os(a):Promise.resolve(null),s?os(l):Promise.resolve(null)]).then(([,u,h])=>{s&&cs(i);const d=as(u,1),f=as(h,-1),g=s?Ni(a):null,_=s?Ni(l):null,m=IE(),p=LE(c),S=o?`pop+=${Jl+ff+mf}`:`pop+=${mf}`,M={scale:0,rotation:df};return e.set(i,{opacity:1,position:"fixed",inset:0,width:"100%",zIndex:1}),Ui(i,M.scale,M.rotation),e.set(n,{scale:Zl,transformOrigin:"50% 50%"}),g&&e.set(g,{x:`${uf}vw`}),_&&e.set(_,{x:`-${uf}vw`}),i.dataset.homeIntroReady="true",e.timeline().to(M,{scale:hf,duration:af,ease:lf,onUpdate:()=>Ui(i,M.scale,M.rotation)}).to(n,{scale:Zl,duration:af,ease:lf},0).add("pop").add(()=>Rc(t,{force:!0}),S).add(()=>Cc(i),S).to({progress:0},{progress:1,duration:cf,ease:ME,onUpdate(){const E=this.targets()[0].progress;M.scale=Ql(hf,bE,E),M.rotation=Ql(df,0,E),Ui(i,M.scale,M.rotation),e.set(n,{scale:Ql(Zl,TE,E)})},onComplete(){e.set(i,{clearProps:"position,inset,width,zIndex,clipPath,webkitClipPath"}),e.set(n,{clearProps:"scale,transformOrigin"}),m.remove()}},"pop").add(gf(e,g),"pop").add(gf(e,_),"pop").add(ls(d),"pop+=0.04").add(ls(f),"pop+=0.04").add(RE(e,p),`pop+=${Jl}`).add(CE(e,p),`pop+=${Jl+ff}`)})}function RE(i,e){return e!=null&&e.outer?i.timeline().set(e.outer,{opacity:0,autoAlpha:0,visibility:"visible"}).to(e.outer,{opacity:1,autoAlpha:1,duration:pf,ease:"power2.out"}):null}function CE(i,e){return e!=null&&e.outer?i.to(e.outer,{opacity:0,duration:pf,ease:"power3.inOut",onComplete:()=>{DE(e)}}):null}function gf(i,e){return e?i.to(e,{x:0,duration:SE,ease:EE,onComplete:()=>i.set(e,{clearProps:"x"})}):null}function PE(){var i,e;return((e=(i=window.matchMedia)==null?void 0:i.call(window,AE))==null?void 0:e.matches)??!0}function Ql(i,e,t){return i+(e-i)*t}function IE(){const i=document.createElement("div");return i.dataset.homeIntroBacking="",i.style.position="fixed",i.style.inset="0",i.style.background="#000",i.style.zIndex="0",i.style.pointerEvents="none",document.body.prepend(i),i}function LE(i){const e=window.gsap;if(!e||!i)return null;if(!i.dataset.andMaskReady){const n=document.createElement("span");n.dataset.andMaskInner="",n.textContent=i.textContent,i.textContent="",i.appendChild(n),i.dataset.andMaskReady="true"}const t=i.querySelector("[data-and-mask-inner]");return e.set(i,{opacity:0,visibility:"visible",overflow:"visible",display:"inline-block",lineHeight:1.15,paddingBottom:"0.05em"}),e.set(t,{display:"inline-block",yPercent:0}),{outer:i,inner:t}}function DE(i){const e=window.gsap;!e||!(i!=null&&i.outer)||!(i!=null&&i.inner)||(e.set(i.outer,{opacity:0,visibility:"visible",clearProps:"overflow,display,lineHeight,paddingBottom"}),e.set(i.inner,{yPercent:0}))}function NE(i){return i.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(e=>{const t=()=>{i.removeEventListener("loadeddata",t),i.removeEventListener("canplay",t),e()};i.addEventListener("loadeddata",t,{once:!0}),i.addEventListener("canplay",t,{once:!0})})}const UE=18,OE=.08,FE=.9,BE=4,_f="(max-width: 991px)",kE=.45,HE=.45,lo=new WeakMap;function VE(i=document){i==null||i.querySelectorAll(".client_spinner").forEach(e=>{if(lo.has(e))return;const t=GE(e);t&&lo.set(e,t)})}function zE(i=document){i==null||i.querySelectorAll(".client_spinner").forEach(e=>{var t;(t=lo.get(e))==null||t.destroy(),lo.delete(e)})}function GE(i){const e=i.querySelector(".spinner_group");if(!e)return null;const t=[e];let n=0,r=0,s=0,o=window.scrollY||window.pageYOffset||0,a=performance.now(),l=null;const c={overflow:i.style.overflow,position:i.style.position,minHeight:i.style.minHeight},u=WE(e);i.style.overflow="hidden",getComputedStyle(i).position==="static"&&(i.style.position="relative"),vf(e),h(),d(),window.addEventListener("resize",d),l=window.requestAnimationFrame(f);function h(){const g=Math.max(BE,Math.ceil((i.clientHeight||window.innerHeight||1)/Math.max(e.offsetHeight,1))+2);for(;t.length<g;){const _=e.cloneNode(!0);_.dataset.spinnerClone="",_.setAttribute("aria-hidden","true"),vf(_),e.parentNode.insertBefore(_,qE(i)),t.push(_)}}function d(){r=Math.max(e.offsetHeight,1),i.style.minHeight=`${r}px`,h()}function f(g){const _=Math.min((g-a)/1e3,.05),m=window.scrollY||window.pageYOffset||0,p=m-o,S=YE(),M=KE();s=s*FE+p*OE*M,n=jE(n+UE*S*_+s,r),t.forEach((E,R)=>{E.style.transform=`translate3d(0, ${R*r-n}px, 0)`}),o=m,a=g,l=window.requestAnimationFrame(f)}return{destroy(){window.cancelAnimationFrame(l),window.removeEventListener("resize",d),t.slice(1).forEach(g=>g.remove()),XE(e,u),i.style.overflow=c.overflow,i.style.position=c.position,i.style.minHeight=c.minHeight}}}function vf(i){i.style.position="absolute",i.style.top="0",i.style.left="0",i.style.right="0",i.style.width="100%",i.style.willChange="transform"}function WE(i){return{position:i.style.position,top:i.style.top,left:i.style.left,right:i.style.right,width:i.style.width,transform:i.style.transform,willChange:i.style.willChange}}function XE(i,e){i.style.position=e.position,i.style.top=e.top,i.style.left=e.left,i.style.right=e.right,i.style.width=e.width,i.style.transform=e.transform,i.style.willChange=e.willChange}function qE(i){return i.querySelector(".spinner_grad")}function YE(){var e,t;return((t=(e=window.matchMedia)==null?void 0:e.call(window,_f))==null?void 0:t.matches)?kE:1}function KE(){var e,t;return((t=(e=window.matchMedia)==null?void 0:e.call(window,_f))==null?void 0:t.matches)?HE:1}function jE(i,e){return(i%e+e)%e}const $E=.4,xf=1,ZE=.18,co=new WeakMap;function JE(i=document){i==null||i.querySelectorAll('[data-shots="hero"] nav').forEach(e=>{const t=[...e.querySelectorAll(".hero_link")];t.length<2||co.has(e)||co.set(e,eb(e,t))})}function QE(i=document){i==null||i.querySelectorAll('[data-shots="hero"] nav').forEach(e=>{var t;(t=co.get(e))==null||t.destroy(),co.delete(e)})}function eb(i,e){const t=new Map(e.map(a=>[a,a.style.opacity]));let n=!1;const r=a=>{if(n)return;const l=a.currentTarget;yf(e,l)},s=()=>{n||e.forEach(a=>ec(a,xf))},o=a=>{n=!0,yf(e,a.currentTarget)};return e.forEach(a=>{a.addEventListener("mouseenter",r),a.addEventListener("focus",r),a.addEventListener("click",o)}),i.addEventListener("mouseleave",s),i.addEventListener("focusout",s),{destroy(){e.forEach(a=>{a.removeEventListener("mouseenter",r),a.removeEventListener("focus",r),a.removeEventListener("click",o),ec(a,t.get(a)||"",!0)}),i.removeEventListener("mouseleave",s),i.removeEventListener("focusout",s)}}}function yf(i,e){i.forEach(t=>{ec(t,t===e?xf:$E)})}function ec(i,e,t=!1){const n=window.gsap;if(n&&!t){n.to(i,{opacity:e,duration:ZE,ease:"power2.out",overwrite:!0});return}i.style.opacity=e}const uo={london:{lat:51.5072,lon:-.1276},miami:{lat:25.7617,lon:-80.1918},hobart:{lat:-42.8821,lon:147.3272},tokyo:{lat:35.6762,lon:139.6503}},tb={amsterdam:{lat:52.3676,lon:4.9041},atlanta:{lat:33.749,lon:-84.388},barcelona:{lat:41.3874,lon:2.1686},berlin:{lat:52.52,lon:13.405},buenosaires:{lat:-34.6037,lon:-58.3816},chicago:{lat:41.8781,lon:-87.6298},copenhagen:{lat:55.6761,lon:12.5683},dubai:{lat:25.2048,lon:55.2708},hongkong:{lat:22.3193,lon:114.1694},losangeles:{lat:34.0522,lon:-118.2437},london:uo.london,madrid:{lat:40.4168,lon:-3.7038},melbourne:{lat:-37.8136,lon:144.9631},mexico:{lat:19.4326,lon:-99.1332},mexicocity:{lat:19.4326,lon:-99.1332},miami:uo.miami,milan:{lat:45.4642,lon:9.19},montreal:{lat:45.5019,lon:-73.5674},mumbai:{lat:19.076,lon:72.8777},newyork:{lat:40.7128,lon:-74.006},paris:{lat:48.8566,lon:2.3522},sanfrancisco:{lat:37.7749,lon:-122.4194},saopaulo:{lat:-23.5558,lon:-46.6396},seoul:{lat:37.5665,lon:126.978},shanghai:{lat:31.2304,lon:121.4737},singapore:{lat:1.3521,lon:103.8198},stockholm:{lat:59.3293,lon:18.0686},sydney:{lat:-33.8688,lon:151.2093},tokyo:uo.tokyo,toronto:{lat:43.6532,lon:-79.3832},vancouver:{lat:49.2827,lon:-123.1207}},nb="-1.2rem",ib="#FFDEAA",rb="#1A365E",sb=32,Sf=1.3,ob="(min-width: 991px)",ab=.9,lb=.55,Mf=28,Ef=18,bf=1.2,cb=-.25,ub=-.18,Tf=10,Af=8,wf=.75,Rf=1,ho="power2.out";function db(i=document){i.querySelectorAll(".map").forEach(hb)}function hb(i){const e=i.querySelector(".map_holder"),t=i.querySelector(".location_card [data-map]"),n=e==null?void 0:e.querySelector(".map_pin[data-map]");if(!e||!t||!n)return;e.querySelectorAll("[data-map-dynamic]").forEach(a=>a.remove());const r=Sb(e);if(!r)return;const s=bb(t),o=[];gb(i,s),s.forEach(a=>{const l=If(a),c=Tb(l);if(!c){console.warn(`[map] No map coordinates for "${l}".`);return}const u=Mb(c,r),h=n.cloneNode(!0);h.dataset.mapDynamic="",h.dataset.mapCity=l,h.removeAttribute("data-map"),h.classList.remove("p1","p2","p3","p4","hq"),h.style.left=`calc(${u.x}% + ${nb})`,h.style.top=`${u.y}%`,h.style.opacity="",h.style.pointerEvents="",h.tabIndex=0,h.setAttribute("aria-label",l),pb(h),e.append(h),o.push(h)}),mb(e),fb(i,e,o,s)}function fb(i,e,t,n){const r=window.gsap,s=t,o=window.matchMedia(ob).matches;let a=null,l="";if(tc(s,null),!o||!r||t.length===0)return;const c=i.querySelector(".location_card"),u=c?r.quickTo(c,"x",{duration:wf,ease:ho}):null,h=c?r.quickTo(c,"y",{duration:wf,ease:ho}):null,d=c?[...c.querySelectorAll(".location_image, img")]:[],f=d.map(M=>r.quickTo(M,"x",{duration:Rf,ease:ho})),g=d.map(M=>r.quickTo(M,"y",{duration:Rf,ease:ho}));r.set(d,{scale:bf,transformOrigin:"50% 50%",force3D:!0});const _=new Map(t.map(M=>[M,{x:r.quickTo(M,"x",{duration:.38,ease:"power3.out"}),y:r.quickTo(M,"y",{duration:.38,ease:"power3.out"})}])),m=()=>{a=null,l="",e.style.cursor="",u==null||u(0),h==null||h(0),Cf(f,g,0,0),_.forEach(M=>{M.x(0),M.y(0)}),fo(t,1),tc(s,null),vb(i)},p=M=>{const E=M.dataset.mapCity||"";a=M,e.style.cursor="pointer",fo(t,1),fo([a],Sf),tc(s,a),E!==l&&(l=E,_b(i,l,n))},S=M=>{const E=yb(M,t);if(!E||E.distance>sb){m();return}p(E.pin),_.forEach((T,C)=>{C!==a&&(T.x(0),T.y(0))});const R=_.get(a);R.x(E.dx),R.y(E.dy),u==null||u(_r(E.dx*ab,-Mf,Mf)),h==null||h(_r(E.dy*lb,-Ef,Ef)),Cf(f,g,E.dx,E.dy),fo([a],Sf)};t.forEach(M=>{M.addEventListener("mouseenter",()=>p(M)),M.addEventListener("focus",()=>p(M))}),e.addEventListener("mousemove",S),e.addEventListener("mouseleave",m)}function pb(i){const e=window.gsap;i.style.transformOrigin="50% 50%",i.style.transition="scale 0.18s ease",i.style.scale="1",i.style.willChange="transform",e&&e.set(i,{x:0,y:0,transformOrigin:"50% 50%",force3D:!0})}function fo(i,e){i.forEach(t=>{t.style.scale=String(e)})}function mb(i){i.querySelectorAll(".map_pin[data-map]").forEach(e=>{e.style.opacity="0",e.style.pointerEvents="none"})}function Cf(i,e,t,n){const r=_r(t*cb,-Tf,Tf),s=_r(n*ub,-Af,Af);i.forEach(o=>o(r)),e.forEach(o=>o(s))}function gb(i,e){const t=window.gsap,n=i.querySelector(".location_card");if(n){if(n.hidden=!1,n.style.display="",window.getComputedStyle(n).display==="none"&&(n.style.display="block"),e.forEach(r=>{r.hidden=!0,r.dataset.mapLocationItem=nc(If(r)),r.style.display="none"}),t){t.set(n,{autoAlpha:0}),t.set(e,{clipPath:"inset(100% 0% 0% 0%)",webkitClipPath:"inset(100% 0% 0% 0%)",y:18});return}n.style.opacity="0",n.style.visibility="hidden"}}function _b(i,e,t){const n=window.gsap,r=i.querySelector(".location_card"),s=nc(e),o=t.find(a=>a.dataset.mapLocationItem===s);if(!(!r||!o)){if(r.hidden=!1,r.style.display="",window.getComputedStyle(r).display==="none"&&(r.style.display="block"),t.forEach(a=>{a.hidden=a!==o,a.style.display=a===o?"":"none"}),!n){r.style.opacity="1",r.style.visibility="visible";return}n.killTweensOf(t),n.set(o.querySelectorAll(".location_image, img"),{scale:bf,transformOrigin:"50% 50%",x:0,y:0}),n.set(r,{autoAlpha:1}),n.fromTo(o,{clipPath:"inset(100% 0% 0% 0%)",webkitClipPath:"inset(100% 0% 0% 0%)",y:18},{clipPath:"inset(0% 0% 0% 0%)",webkitClipPath:"inset(0% 0% 0% 0%)",y:0,duration:.6,ease:"power3.inOut",overwrite:!0})}}function vb(i){const e=window.gsap,t=i.querySelector(".location_card"),n=[...(t==null?void 0:t.querySelectorAll(".location_item, .w-dyn-item"))||[]];if(t){if(e){e.killTweensOf(n),e.to(n,{clipPath:"inset(0% 0% 100% 0%)",webkitClipPath:"inset(0% 0% 100% 0%)",y:-18,duration:.4,ease:"power4.out",overwrite:!0,onComplete:()=>{e.set(t,{autoAlpha:0,x:0,y:0}),e.set(t.querySelectorAll(".location_image, img"),{x:0,y:0})}});return}t.style.opacity="0",t.style.visibility="hidden"}}function tc(i,e){var t;xb((t=i[0])==null?void 0:t.closest(".map_holder"),!!e),i.forEach(n=>{const r=!e||n===e?ib:rb;n.style.backgroundColor=r,n.style.color=r,n.querySelectorAll("svg, path, circle, rect, polygon").forEach(s=>{s.style.fill=r,s.style.stroke=r})})}function xb(i,e){if(!i)return;const t=i.querySelector('[data-hq="inactive"]'),n=i.querySelector('[data-hq="active"]');t&&(t.style.opacity=e?"1":"0"),n&&(n.style.opacity=e?"0":"1")}function yb(i,e){return e.reduce((t,n)=>{const r=n.getBoundingClientRect(),s=r.left+r.width/2,o=r.top+r.height/2,a=i.clientX-s,l=i.clientY-o,c=Math.hypot(a,l);return!t||c<t.distance?{pin:n,dx:a,dy:l,distance:c}:t},null)}function Sb(i){const e=Object.entries(uo).map(([t,n])=>{const r=i.querySelector(`[data-map="${t}"]`),s=Eb(r,i);return s?{...n,...s}:null}).filter(Boolean);return e.length<2?null:{xFit:Pf(e.map(t=>[t.lon,t.x])),yFit:Pf(e.map(t=>[t.lat,t.y]))}}function Mb(i,e){return{x:_r(e.xFit.a*i.lon+e.xFit.b,0,100),y:_r(e.yFit.a*i.lat+e.yFit.b,0,100)}}function Pf(i){const e=i.length,t=i.reduce((c,u)=>c+u[0],0),n=i.reduce((c,u)=>c+u[1],0),r=i.reduce((c,u)=>c+u[0]*u[1],0),s=i.reduce((c,u)=>c+u[0]*u[0],0),o=e*s-t*t||1,a=(e*r-t*n)/o,l=(n-a*t)/e;return{a,b:l}}function Eb(i,e){if(!i)return null;const t=e.getBoundingClientRect(),n=i.getBoundingClientRect();return!t.width||!t.height?null:{x:(n.left+n.width/2-t.left)/t.width*100,y:(n.top+n.height/2-t.top)/t.height*100}}function bb(i){return[...i.querySelectorAll(".location_item, .w-dyn-item")]}function If(i){return[...i.children].filter(t=>t.matches("h1,h2,h3,h4,h5,h6,p,div,span")).map(t=>t.textContent.trim()).filter(Boolean)[0]||""}function Tb(i){return tb[nc(i)]}function nc(i){return String(i||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z]/g,"")}function _r(i,e,t){return Math.min(Math.max(i,e),t)}const ic=new WeakMap;function Ab(i=document){var n;const e=[...((n=i.querySelectorAll)==null?void 0:n.call(i,".nav"))||[]].filter(r=>r.querySelector(".mob_nav"));if(!e.length)return;Lf(i),rc(i,!1);const t=new AbortController;e.forEach(r=>{r.addEventListener("click",s=>{var l,c,u,h;const o=(c=(l=s.target).closest)==null?void 0:c.call(l,".mob_nav .right_box .nav_link, .hamburger.close, .hamburger.off"),a=(h=(u=s.target).closest)==null?void 0:h.call(u,".hamburger");if(o){s.preventDefault(),s.stopPropagation(),rc(r,!1);return}a&&(s.preventDefault(),s.stopPropagation(),rc(r,!0))},{capture:!0,signal:t.signal})}),ic.set(i,t)}function Lf(i=document){var e;(e=ic.get(i))==null||e.abort(),ic.delete(i)}function rc(i,e){i.querySelectorAll(".mob_nav").forEach(t=>{t.style.setProperty("display",e?"flex":"none","important"),t.style.setProperty("opacity",e?"1":"0","important"),t.style.setProperty("visibility",e?"visible":"hidden","important"),t.style.setProperty("pointer-events",e?"auto":"none","important"),t.setAttribute("aria-hidden",e?"false":"true")})}function wb(){return document.readyState!=="loading"?Promise.resolve():new Promise(i=>{document.addEventListener("DOMContentLoaded",i,{once:!0})})}const wi={three:{spin(){Wn.forEach(i=>i==null?void 0:i.spin())},animateToProgress(i,e){Wn.forEach(t=>{var n;return(n=t==null?void 0:t.animateToProgress)==null?void 0:n.call(t,i,e)})},setNamespace(i){Wn.forEach(e=>e==null?void 0:e.setNamespace(i))}},barba:null},Wn=new Map,Ot="[MM lifecycle]";_p(),ug();const sc={home({namespace:i}){var e;(e=wi.three)==null||e.setNamespace(i)}};async function Rb(){if(await wb(),Bb(),wi.barba=Yg({onEnter:Df,onLeave:Cb,onTransitionStart:({namespace:i}={})=>{var e,t;(e=wi.three)==null||e.spin(),(i==="home"||i==="contact")&&((t=wi.three)==null||t.animateToProgress(0,.55))}}),!wi.barba){const i=document.querySelector("[data-barba='container']");console.log(Ot,"no barba -> setup attempt",Zt(i)),Df({container:i,namespace:oc(i)})}}async function Df({container:i,namespace:e,transition:t=!1}){var r,s,o,a;if(!i){console.log(Ot,"setup skipped -> no container");return}const n=Nf(e||oc(i));t&&n==="home"&&(i.dataset.homeIntroReady="true"),console.log(Ot,"setup start",{...Zt(i,n),transition:t}),i.dataset.pageActive="true",document.body.dataset.page=n,Nb(i)&&(console.log(Ot,"run shots()",{...Zt(i,n),hero:i.querySelectorAll('[data-shots="hero"]').length,featuredLists:i.querySelectorAll("[data-featured-list]").length}),await Wp(i)),Db(i)&&(await Uf(),(r=window.ScrollTrigger)==null||r.refresh(),console.log(Ot,"run three()",{...Zt(i,n),mounts:i.querySelectorAll("[data-three-canvas]").length}),Pb(i),(s=wi.three)==null||s.setNamespace(n)),Ob(i),Fb(i),VE(i),JE(i),Ab(i),db(i),dg(i,{autoAnimate:!t}),console.log(Ot,"reinit webflow",{...Zt(i,n),hasWebflow:!!window.Webflow}),Lb(),Ub(i)&&(console.log(Ot,"run text()",{...Zt(i,n),transition:t}),await Uf(),To(i),yp(i,{autoAnimate:!t&&n!=="home"})),!t&&n==="home"&&await wE(i),t||Fc(i),(o=window.ScrollTrigger)==null||o.refresh(),console.log(Ot,"setup complete",Zt(i,n)),(a=sc[n])==null||a.call(sc,{container:i,namespace:n})}function Cb({container:i}){if(!i){console.log(Ot,"teardown skipped -> no container");return}console.log(Ot,"teardown start",Zt(i)),console.log(Ot,"stop shots",Zt(i)),Xp(i),console.log(Ot,"reset text on leave",Zt(i)),To(i),console.log(Ot,"destroy three",{...Zt(i),mounts:i.querySelectorAll("[data-three-canvas]").length}),Ib(i),zE(i),QE(i),Lf(i),Su(i),delete i.dataset.pageActive,console.log(Ot,"teardown complete",Zt(i))}Rb();function Pb(i=document){Wn.forEach((e,t)=>{t.isConnected||(e==null||e.destroy(),Wn.delete(t))}),i==null||i.querySelectorAll("[data-three-canvas]").forEach(e=>{if(Wn.has(e))return;const t=_E({mount:e});t&&Wn.set(e,t)})}function Ib(i){i==null||i.querySelectorAll("[data-three-canvas]").forEach(e=>{var t;(t=Wn.get(e))==null||t.destroy(),Wn.delete(e)})}function Nf(i){return String(i||"page").trim().toLowerCase()}function oc(i){var e;return((e=i==null?void 0:i.dataset)==null?void 0:e.barbaNamespace)||"page"}function Lb(){var e,t,n,r,s;const i=window.Webflow;i&&((e=i.destroy)==null||e.call(i),(t=i.ready)==null||t.call(i),(s=(r=(n=i.require)==null?void 0:n.call(i,"ix2"))==null?void 0:r.init)==null||s.call(r))}async function Uf(){var i,e,t;return await((t=(e=(i=document.fonts)==null?void 0:i.ready)==null?void 0:e.catch)==null?void 0:t.call(e,()=>{})),new Promise(n=>{requestAnimationFrame(()=>requestAnimationFrame(n))})}function Zt(i,e){var t;return{namespace:Nf(e||oc(i)),active:((t=i==null?void 0:i.dataset)==null?void 0:t.pageActive)==="true",connected:!!(i!=null&&i.isConnected),className:(i==null?void 0:i.className)||""}}function Db(i){return!!(i!=null&&i.querySelector("[data-three-canvas]"))}function Nb(i){return!!(i!=null&&i.querySelector("[data-shots], [data-featured-list], [data-shots-work], [data-shots-showreel], [data-showreel-id], [data-showreel-stream], [data-direct-id]"))}function Ub(i){return!!(i!=null&&i.querySelector("h1, h2, h3, h4, h5, h6, p, [data-text], .filter, .w-inline-block, .body-large, .body-regular, .body-small, .link_large, .link_small, .nav_link, .heading-1, .heading-2, .heading-3, .heading-4, .heading-5, .heading-6"))}function Ob(i=document){const e=i==null?void 0:i.querySelectorAll(".directors_list, .director_list, [data-directors='list']");if(!(e!=null&&e.length))return;const t=Of(window.location.pathname);e.forEach(n=>{n.querySelectorAll("a[href]").forEach(r=>{const o=Of(new URL(r.href,window.location.href).pathname)===t||r.getAttribute("aria-current")==="page"||r.classList.contains("w--current");r.style.opacity=o?"1":"",r.style.color=o?"":"#C3C3C3"})})}function Of(i){return String(i||"/").replace(/\/+$/,"")||"/"}function Fb(i=document){const e=String(new Date().getFullYear());i==null||i.querySelectorAll("[data-year]").forEach(t=>{t.textContent=e})}function Bb(){const i=window.gsap,e=window.ScrollTrigger;!i||!e||!window.Lenis||window.__mmLenisScrollTriggerBridge||(window.__mmLenisScrollTriggerBridge=!0,i.ticker.add(()=>e.update()),i.ticker.lagSmoothing(0))}return _o.app=wi,Object.defineProperty(_o,Symbol.toStringTag,{value:"Module"}),_o})({});
