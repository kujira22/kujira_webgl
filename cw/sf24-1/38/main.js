 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var cn,Zu,Jn,Ur,Or,po,d_,ls,da,p_,or,Si,m_,__=function(){return cn||typeof window<"u"&&(cn=window.gsap)&&cn.registerPlugin&&cn},g_=1,oo=[],rt=[],zi=[],pa=Date.now,Ju=function(e,t){return t},Av=function(){var e=da.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,rt),i.push.apply(i,zi),rt=n,zi=i,Ju=function(o,a){return t[o](a)}},Vr=function(e,t){return~zi.indexOf(e)&&zi[zi.indexOf(e)+1][t]},ma=function(e){return!!~p_.indexOf(e)},Tn=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:!i,capture:!!s})},Sn=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},qa="scrollLeft",Ya="scrollTop",Qu=function(){return or&&or.isPressed||rt.cache++},lc=function(e,t){var n=function i(s){if(s||s===0){g_&&(Jn.history.scrollRestoration="manual");var o=or&&or.isPressed;s=i.v=Math.round(s)||(or&&or.iOS?1:0),e(s),i.cacheID=rt.cache,o&&Ju("ss",s)}else(t||rt.cache!==i.cacheID||Ju("ref"))&&(i.cacheID=rt.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},Pn={s:qa,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:lc(function(r){return arguments.length?Jn.scrollTo(r,$t.sc()):Jn.pageXOffset||Ur[qa]||Or[qa]||po[qa]||0})},$t={s:Ya,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:Pn,sc:lc(function(r){return arguments.length?Jn.scrollTo(Pn.sc(),r):Jn.pageYOffset||Ur[Ya]||Or[Ya]||po[Ya]||0})},Un=function(e,t){return(t&&t._ctx&&t._ctx.selector||cn.utils.toArray)(e)[0]||(typeof e=="string"&&cn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},Yr=function(e,t){var n=t.s,i=t.sc;ma(e)&&(e=Ur.scrollingElement||Or);var s=rt.indexOf(e),o=i===$t.sc?1:2;!~s&&(s=rt.push(e)-1),rt[s+o]||Tn(e,"scroll",Qu);var a=rt[s+o],l=a||(rt[s+o]=lc(Vr(e,n),!0)||(ma(e)?i:lc(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,a||(l.smooth=cn.getProperty(e,"scrollBehavior")==="smooth"),l},eh=function(e,t,n){var i=e,s=e,o=pa(),a=o,l=t||50,c=Math.max(500,l*3),u=function(_,g){var m=pa();g||m-o>l?(s=i,i=_,a=o,o=m):n?i+=_:i=s+(_-s)/(m-a)*(o-a)},f=function(){s=i=n?0:i,a=o=0},h=function(_){var g=a,m=s,p=pa();return(_||_===0)&&_!==i&&u(_),o===a||p-a>c?0:(i+(n?m:-m))/((n?p:o)-g)*1e3};return{update:u,reset:f,getVelocity:h}},Xo=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},hd=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},v_=function(){da=cn.core.globals().ScrollTrigger,da&&da.core&&Av()},x_=function(e){return cn=e||__(),cn&&typeof document<"u"&&document.body&&(Jn=window,Ur=document,Or=Ur.documentElement,po=Ur.body,p_=[Jn,Ur,Or,po],cn.utils.clamp,m_=cn.core.context||function(){},ls="onpointerenter"in po?"pointer":"mouse",d_=jt.isTouch=Jn.matchMedia&&Jn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Jn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Si=jt.eventTypes=("ontouchstart"in Or?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Or?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return g_=0},500),v_(),Zu=1),Zu};Pn.op=$t;rt.cache=0;var jt=function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){Zu||x_(cn)||console.warn("Please gsap.registerPlugin(Observer)"),da||v_();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,f=n.onStop,h=n.onStopDelay,d=n.ignore,_=n.wheelSpeed,g=n.event,m=n.onDragStart,p=n.onDragEnd,M=n.onDrag,S=n.onPress,x=n.onRelease,A=n.onRight,R=n.onLeft,E=n.onUp,w=n.onDown,y=n.onChangeX,v=n.onChangeY,P=n.onChange,D=n.onToggleX,O=n.onToggleY,U=n.onHover,V=n.onHoverEnd,z=n.onMove,W=n.ignoreCheck,H=n.isNormalizer,J=n.onGestureStart,L=n.onGestureEnd,oe=n.onWheel,Se=n.onEnable,Ne=n.onDisable,K=n.onClick,ie=n.scrollSpeed,me=n.capture,se=n.allowClicks,be=n.lockAxis,Ae=n.onLockAxis;this.target=a=Un(a)||Or,this.vars=n,d&&(d=cn.utils.toArray(d)),i=i||1e-9,s=s||0,_=_||1,ie=ie||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Jn.getComputedStyle(po).lineHeight)||22);var He,et,We,Ie,I,Et,ke,G=this,Me=0,ct=0,we=Yr(a,Pn),C=Yr(a,$t),T=we(),X=C(),te=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Si[0]==="pointerdown",ee=ma(a),Z=a.ownerDocument||Ur,xe=[0,0,0],ae=[0,0,0],_e=0,Xe=function(){return _e=pa()},re=function(he,qe){return(G.event=he)&&d&&~d.indexOf(he.target)||qe&&te&&he.pointerType!=="touch"||W&&W(he,qe)},fe=function(){G._vx.reset(),G._vy.reset(),et.pause(),f&&f(G)},Pe=function(){var he=G.deltaX=hd(xe),qe=G.deltaY=hd(ae),mt=Math.abs(he)>=i,ye=Math.abs(qe)>=i;P&&(mt||ye)&&P(G,he,qe,xe,ae),mt&&(A&&G.deltaX>0&&A(G),R&&G.deltaX<0&&R(G),y&&y(G),D&&G.deltaX<0!=Me<0&&D(G),Me=G.deltaX,xe[0]=xe[1]=xe[2]=0),ye&&(w&&G.deltaY>0&&w(G),E&&G.deltaY<0&&E(G),v&&v(G),O&&G.deltaY<0!=ct<0&&O(G),ct=G.deltaY,ae[0]=ae[1]=ae[2]=0),(Ie||We)&&(z&&z(G),We&&(M(G),We=!1),Ie=!1),Et&&!(Et=!1)&&Ae&&Ae(G),I&&(oe(G),I=!1),He=0},Ue=function(he,qe,mt){xe[mt]+=he,ae[mt]+=qe,G._vx.update(he),G._vy.update(qe),c?He||(He=requestAnimationFrame(Pe)):Pe()},ge=function(he,qe){be&&!ke&&(G.axis=ke=Math.abs(he)>Math.abs(qe)?"x":"y",Et=!0),ke!=="y"&&(xe[2]+=he,G._vx.update(he,!0)),ke!=="x"&&(ae[2]+=qe,G._vy.update(qe,!0)),c?He||(He=requestAnimationFrame(Pe)):Pe()},Ye=function(he){if(!re(he,1)){he=Xo(he,u);var qe=he.clientX,mt=he.clientY,ye=qe-G.x,it=mt-G.y,Le=G.isDragging;G.x=qe,G.y=mt,(Le||Math.abs(G.startX-qe)>=s||Math.abs(G.startY-mt)>=s)&&(M&&(We=!0),Le||(G.isDragging=!0),ge(ye,it),Le||m&&m(G))}},Be=G.onPress=function(Re){re(Re,1)||Re&&Re.button||(G.axis=ke=null,et.pause(),G.isPressed=!0,Re=Xo(Re),Me=ct=0,G.startX=G.x=Re.clientX,G.startY=G.y=Re.clientY,G._vx.reset(),G._vy.reset(),Tn(H?a:Z,Si[1],Ye,u,!0),G.deltaX=G.deltaY=0,S&&S(G))},ut=G.onRelease=function(Re){if(!re(Re,1)){Sn(H?a:Z,Si[1],Ye,!0);var he=!isNaN(G.y-G.startY),qe=G.isDragging&&(Math.abs(G.x-G.startX)>3||Math.abs(G.y-G.startY)>3),mt=Xo(Re);!qe&&he&&(G._vx.reset(),G._vy.reset(),u&&se&&cn.delayedCall(.08,function(){if(pa()-_e>300&&!Re.defaultPrevented){if(Re.target.click)Re.target.click();else if(Z.createEvent){var ye=Z.createEvent("MouseEvents");ye.initMouseEvent("click",!0,!0,Jn,1,mt.screenX,mt.screenY,mt.clientX,mt.clientY,!1,!1,!1,!1,0,null),Re.target.dispatchEvent(ye)}}})),G.isDragging=G.isGesturing=G.isPressed=!1,f&&!H&&et.restart(!0),p&&qe&&p(G),x&&x(G,qe)}},N=function(he){return he.touches&&he.touches.length>1&&(G.isGesturing=!0)&&J(he,G.isDragging)},ue=function(){return(G.isGesturing=!1)||L(G)},j=function(he){if(!re(he)){var qe=we(),mt=C();Ue((qe-T)*ie,(mt-X)*ie,1),T=qe,X=mt,f&&et.restart(!0)}},Q=function(he){if(!re(he)){he=Xo(he,u),oe&&(I=!0);var qe=(he.deltaMode===1?l:he.deltaMode===2?Jn.innerHeight:1)*_;Ue(he.deltaX*qe,he.deltaY*qe,0),f&&!H&&et.restart(!0)}},ce=function(he){if(!re(he)){var qe=he.clientX,mt=he.clientY,ye=qe-G.x,it=mt-G.y;G.x=qe,G.y=mt,Ie=!0,(ye||it)&&ge(ye,it)}},de=function(he){G.event=he,U(G)},ze=function(he){G.event=he,V(G)},pt=function(he){return re(he)||Xo(he,u)&&K(G)};et=G._dc=cn.delayedCall(h||.25,fe).pause(),G.deltaX=G.deltaY=0,G._vx=eh(0,50,!0),G._vy=eh(0,50,!0),G.scrollX=we,G.scrollY=C,G.isDragging=G.isGesturing=G.isPressed=!1,m_(this),G.enable=function(Re){return G.isEnabled||(Tn(ee?Z:a,"scroll",Qu),o.indexOf("scroll")>=0&&Tn(ee?Z:a,"scroll",j,u,me),o.indexOf("wheel")>=0&&Tn(a,"wheel",Q,u,me),(o.indexOf("touch")>=0&&d_||o.indexOf("pointer")>=0)&&(Tn(a,Si[0],Be,u,me),Tn(Z,Si[2],ut),Tn(Z,Si[3],ut),se&&Tn(a,"click",Xe,!1,!0),K&&Tn(a,"click",pt),J&&Tn(Z,"gesturestart",N),L&&Tn(Z,"gestureend",ue),U&&Tn(a,ls+"enter",de),V&&Tn(a,ls+"leave",ze),z&&Tn(a,ls+"move",ce)),G.isEnabled=!0,Re&&Re.type&&Be(Re),Se&&Se(G)),G},G.disable=function(){G.isEnabled&&(oo.filter(function(Re){return Re!==G&&ma(Re.target)}).length||Sn(ee?Z:a,"scroll",Qu),G.isPressed&&(G._vx.reset(),G._vy.reset(),Sn(H?a:Z,Si[1],Ye,!0)),Sn(ee?Z:a,"scroll",j,me),Sn(a,"wheel",Q,me),Sn(a,Si[0],Be,me),Sn(Z,Si[2],ut),Sn(Z,Si[3],ut),Sn(a,"click",Xe,!0),Sn(a,"click",pt),Sn(Z,"gesturestart",N),Sn(Z,"gestureend",ue),Sn(a,ls+"enter",de),Sn(a,ls+"leave",ze),Sn(a,ls+"move",ce),G.isEnabled=G.isPressed=G.isDragging=!1,Ne&&Ne(G))},G.kill=G.revert=function(){G.disable();var Re=oo.indexOf(G);Re>=0&&oo.splice(Re,1),or===G&&(or=0)},oo.push(G),H&&ma(a)&&(or=G),G.enable(g)},wv(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();jt.version="3.12.2";jt.create=function(r){return new jt(r)};jt.register=x_;jt.getAll=function(){return oo.slice()};jt.getById=function(r){return oo.filter(function(e){return e.vars.id===r})[0]};__()&&cn.registerPlugin(jt);/*!
