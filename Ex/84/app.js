...
const panel2sound = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
  src: ["https://cdn.jsdelivr.net/gh/kujira22/kujira_webgl@main/Ex/wav/Transition_Op8.wav"],
});

const menutransout = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
  src: ["https://cdn.jsdelivr.net/gh/kujira22/kujira_webgl@main/Ex/wav/Transition_Op8.wav"],
});
...
var elements = document.querySelectorAll('.sb01, .sb02, .sb04');
elements.forEach(function(element) {
  element.addEventListener('click', function() {
    transoutsound.play();
  });
...
var elements = document.querySelectorAll('.menu_close, .sb01, .sb02, .sb04');
elements.forEach(function(element) {
  element.addEventListener('click', function() {
