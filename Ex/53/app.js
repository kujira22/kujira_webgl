    ...
    transitions: [
        {
                ...
                if (document.fonts.check('1em "Exabstract Exabstractvf"')) {
                  ...
                  document.fonts.onloadingdone = function(evt) {
                      if (evt.fontfaces.some(face => face.family === 'Exabstract Exabstractvf')) {
                          // The desired font has finished loading
                          initAOSTextAnimation();
                      }
                  };
              }  
            ...
            leave({ current, next, trigger }) {
              if (trigger && (trigger.classList.contains('menu_link') || trigger.classList.contains('home_link_menu') ||  trigger.classList.contains('menu_filter') ||  trigger.classList.contains('menu_link_large') || trigger.classList.contains('menu_close'))) {
...
function chaos() {
    ...
    function updateFontChaos() {
        // If the scroll position is in the top 50vh, prevent the effect on .logo_home_main.ex
        if (window.scrollY < window.innerHeight * 0.5) {
            gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".logo_home_main.ex", {
                fontVariationSettings: `'chao' 50`,
                duration: 0.5,
                ease: "power3.out",
                overwrite: "all"
