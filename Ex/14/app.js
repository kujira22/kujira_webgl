...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger, gsap_TextPlugin__WEBPACK_IMPORTED_MODULE_2__.TextPlugin, gsap_CSSRulePlugin__WEBPACK_IMPORTED_MODULE_3__.CSSRulePlugin);
    ...
    const chaosElements = document.querySelectorAll(".pagewrapper");
    ...
    function handleScroll() {
        ...
        updateFontChaos(scrollDelta);
        lastScrollTop = scrollTop;
    }
    
    function updateFontChaos(speed) {
        // Map the speed value to a range of 50-1000. The faster the speed, the higher the 'chao'.
        // Adjust the numbers as needed to get desired effect.
        let chaoValue = mapRange(speed, 0, 100, 50, 1000);
        chaoValue = Math.min(Math.max(chaoValue, 50), 1000);
    
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(chaosElements, {
            "--chao": chaoValue, // assuming your variable font CSS property is named "--chao"
            duration: 0.5,       // adjust for desired transition speed
            ease: "power3.out"
        });
    }
