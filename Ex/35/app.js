...
function chaos() {
    ...
    const chaosElements = document.querySelectorAll(".h1, .logo_home_main, .logo_home_main_menu, .cursor");
...
function enhancedProximityChaos() {
    ...
    const originalColors = {
        background: getComputedStyle(document.querySelector('.gate')).backgroundColor,
        logo: getComputedStyle(document.querySelector('.logo_gate_holder', '.enter')).color,
    };
    ...
    function cycleColors() {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.gate', { backgroundColor: colorCombos[currentColorIndex].background });
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(['.logo_gate_holder', '.logo_gate_holder *', '.enter', '.enter *'], {  // Targeting logo_gate_holder and all its children
    ...
    function stopColorCycling() {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.gate', { backgroundColor: originalColors.background });
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(['.logo_gate_holder', '.logo_gate_holder *', '.enter', '.enter *'], { color: originalColors.logo }); // Targeting logo_gate_holder and all its children
    }
    ...
    function handleMouseMove(e) {
        ...
        inactivityTimeout = setTimeout(resetMultiplier, 100);
    }
