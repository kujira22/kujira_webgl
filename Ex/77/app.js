...
const sliderslide = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
  src: ["https://cdn.jsdelivr.net/gh/kujira22/kujira_webgl@main/Ex/wav/Transition_Op5.wav"],
});
...
const menusoundbed = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
  src: ["https://cdn.jsdelivr.net/gh/kujira22/kujira_webgl@main/Ex/wav/SB_op1.wav"],
  loop: true
});

const homesoundbed = new howler__WEBPACK_IMPORTED_MODULE_1__.Howl({
  src: ["https://cdn.jsdelivr.net/gh/kujira22/kujira_webgl@main/Ex/wav/SB_op4.wav"],
  loop: true
});
...
var elements = document.querySelectorAll('.menu_close, .sb1, .sb2, sb3');
elements.forEach(function(element) {
  element.addEventListener('click', function() {
...
function homebedplay() {
  homesoundbed.play();
  homesoundbed.fade(0, 1, 1000);
}

function homebedstop() {
  homesoundbed.fade(1, 0, 1000);
  homesoundbed.once('fade', function(){
  homesoundbed.stop();
  });
}
