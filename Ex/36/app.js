...
function chaos() {
    ...
    const chaosElements = document.querySelectorAll(".h1, .logo_home_main, .logo_home_main_menu, .logo_home_main_menu_full");
    ...
    function updateFontChaos() {
        ...
        let targetChaoValue = sustainCounter > 5 ? (sustainCounter - 5) * 10 : 50; // Multiplier of 5 for pronounced effect
