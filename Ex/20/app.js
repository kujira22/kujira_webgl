...
function menudark() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(".home_link", {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(".home_link_dark", {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(".menu_burger", {
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(".menu_burger_dark", {
...
function menulight() {
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".home_link", {
display: "block",
});

gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".home_link_dark", {
display: "none",
});
    ...
    transitions: [
        {
            ...
            leave({ current, next, trigger }) {
              if (trigger && (trigger.classList.contains('menu_link') || trigger.classList.contains('home_link_menu') || trigger.classList.contains('menu_filter'))) {
...
function chaos() {
    ...
    const chaosElements = document.querySelectorAll(".page");
    ...
    function updateFontChaos() {
        ...
        let targetChaoValue = sustainCounter > 10 ? (sustainCounter - 10) * 5 : 50; // Multiplier of 5 for pronounced effect
